...
var queryId = "#id_eventNm";							// 검색어 <input> 의 id을 설정한다
var arkId = "#id_eventArk";								// 자동완성 전체 <div> 의 id을 설정한다
...
var target = "event";								// ARK 웹서버 설정파일의 목록에 있는 추천어 서비스 대상을 지정한다.
var charset = "utf-8";							// 인코딩 설정 (인코딩이 utf-8이 아닐 경우 8859_1 로 설정해야함)
var datatype = "json";							// 반환받을 Data의 타입을 설정. XML 과 JSON이 가능 (xml | json)
var arkPath = "";						// 자동완성 경로
var transURL = "/ark/event";		// trans 페이지의 URL을 설정한다.
var tempQuery = "";
...
/** ARK 구성요소의 위치 및 크기를 아래 변수를 통해 조정함. **/
var arkWidth = 4;								// 자동완성 전체 넓이 값을 설정한다(변동폭).
var arkTop = -55;								// 자동완성 상단에서의 위치 값을 설정한다.
var arkLeft = -75;								// 자동완성 왼쪽에서의 위치 값을 설정한다.
var arkImgTop = -52;								// 자동완성 화살표 이미지의 상단에서 위치 값을 설정한다.
var arkImgLeft = -81;							// 자동완성 화살표 이미지의 왼쪽에서 위치 값을 설정한다.
...
function setArkLocation() {
	...
	// ARK Wrap의 위치 설정
	$("#" + wrapId).css({"position" : "absolute", "top" : arkTop, "left" : arkLeft, "background-color" : "#FFF" });
